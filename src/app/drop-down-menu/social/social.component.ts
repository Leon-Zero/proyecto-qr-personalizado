...
export class SocialComponent implements OnInit {
  ...
  constructor( private cargaService: CargarScriptService,
               public qrService: QrValuesService) {
      cargaService.carga(['iconSocial'])  
  }
    ...
    "icons": [
      {
        ...
        "index": 0,
        "css":"fa-brands fa-linkedin linkedin",
      },
      {
        "name": "instagram",
        ...
        "index": 100,
        "css":"fa-brands fa-instagram instagram",
      },
      {
        "name": "facebook",
        ...
        "index": 200,
        "css":"fa-brands fa-facebook-f facebook",
      },
      {
        "name": "twitter",
        ...
        "index": 300,
        "css":"fa-brands fa-twitter twitter",
      },
      {
        "name": "whatsapp",
        ...
        "index": 400,
        "css":"fa-brands fa-whatsapp whatsapp",
      }
    ]
  };
  ...
  ngOnInit(): void {   }
   ...
   setDropdownProps = (deg: number, ht: number, opacity: string) => {
     ...
     this.root.style.setProperty("--rotate-arrow-social", setDeg !== ceroDeg? setDeg : '0' );
     this.root.style.setProperty("--dropdown-height-social", setHt !== ceroHt ? setHt : '0');
     this.root.style.setProperty("--list-opacity-social", opacity);
   };
   ...
   dropdownBtn(){
     ...
     const currDropdownHeight = this.root.style.getPropertyValue("--dropdown-height-social") || "0";
